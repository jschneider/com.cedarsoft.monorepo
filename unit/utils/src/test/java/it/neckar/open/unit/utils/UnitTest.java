...
import it.neckar.open.unit.si.m_s;
import it.neckar.open.unit.si.mm;
import it.neckar.open.unit.si.rad;
import it.neckar.open.unit.si.s;
import it.neckar.open.unit.utils.prefix.Prefixed;
...
public class UnitTest {
  ...
  public void testReflection() throws Exception {
    ...
    assertEquals("it.neckar.open.unit.si.m", annotation.annotationType().getName());
  ...
  public void testReflCm() throws Exception {
    ...
    Annotation annotation = method.getParameterAnnotations()[0][0];
    assertEquals("it.neckar.open.unit.si.cm", annotation.annotationType().getName());
