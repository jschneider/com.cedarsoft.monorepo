...
import com.cedarsoft.i18n.TextService
import com.cedarsoft.i18n.TextService.Companion.withFallback
import com.cedarsoft.i18n.resolver.ResourceBundleTextResolver
...
class TestException : ApplicationException {
  ...
  enum class TestExceptionDetails(
    ...
    @Nonnull
    private val textService: TextService = withFallback(ResourceBundleTextResolver("com.cedarsoft.exceptions.testmessages"))
