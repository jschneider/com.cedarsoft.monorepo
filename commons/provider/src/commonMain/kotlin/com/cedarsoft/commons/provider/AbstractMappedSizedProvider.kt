...
import com.cedarsoft.commons.provider.impl.IndexMappingSupport
...
abstract class AbstractMappedSizedProvider<T>(
   ...
   *
   * Implementations must add entries using the provided [com.cedarsoft.commons.provider.impl.IndexMappingSupport.StoreIndex]
