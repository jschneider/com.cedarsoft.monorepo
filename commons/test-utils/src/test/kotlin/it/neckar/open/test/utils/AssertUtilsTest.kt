...
import it.neckar.open.test.utils.AssertUtils.assertEquals
import it.neckar.open.test.utils.AssertUtils.assertFileByHash
import it.neckar.open.test.utils.AssertUtils.assertXMLEquals
import it.neckar.open.test.utils.AssertUtils.createCopyFile
import it.neckar.open.test.utils.AssertUtils.createPath
import it.neckar.open.test.utils.AssertUtils.guessPathFromStackTrace
import it.neckar.open.test.utils.JsonUtils.assertJsonEquals
import it.neckar.open.test.utils.JsonUtils.formatJson
...
class AssertUtilsTest {
  ...
  fun testGuessPath() {
    ...
    Assert.assertEquals("it.neckar.open.test.utils.AssertUtilsTest" + File.separator + "testGuessPath", guess())
  }
