...
internal class DecimalFormatTest {
  ...
  internal fun testSimple() {
    val de = I18nConfiguration.Germany.copy(formatLocale = com.cedarsoft.i18n.Locale("de"))
    ...
    val deDe = I18nConfiguration.Germany.copy(formatLocale = com.cedarsoft.i18n.Locale("de-DE"))
  ...
  fun testExponentialFormat() {
    assertThat(ExponentialFormat.createExponentialFormat(2, 2, 1, com.cedarsoft.i18n.Locale.US).format(123456.0)).isEqualTo("1.23e5")
    assertThat(ExponentialFormat.createExponentialFormat(2, 2, 1, com.cedarsoft.i18n.Locale.Germany).format(123456.0)).isEqualTo("1,23e5")
    assertThat(ExponentialFormat.createExponentialFormat(2, 2, 1, com.cedarsoft.i18n.Locale.US).format(123456.78)).isEqualTo("1.23e5")
    assertThat(ExponentialFormat.createExponentialFormat(3, 2, 1, com.cedarsoft.i18n.Locale.US).format(123.78)).isEqualTo("1.238e2")
    assertThat(ExponentialFormat.createExponentialFormat(3, 2, 1, com.cedarsoft.i18n.Locale.US).format(-123.78)).isEqualTo("-1.238e2")
    assertThat(ExponentialFormat.createExponentialFormat(3, 2, 3, com.cedarsoft.i18n.Locale.US).format(1234.78)).isEqualTo("123.478e1")
    assertThat(ExponentialFormat.createExponentialFormat(3, 2, 1, com.cedarsoft.i18n.Locale.US).format(1.1)).isEqualTo("1.10e0")
    assertThat(ExponentialFormat.createExponentialFormat(3, 2, 1, com.cedarsoft.i18n.Locale.US).format(10.1)).isEqualTo("1.01e1")
    assertThat(ExponentialFormat.createExponentialFormat(3, 2, 1, com.cedarsoft.i18n.Locale.US).format(-0.0)).isEqualTo("-0.00e0")
    assertThat(ExponentialFormat.createExponentialFormat(3, 2, 1, com.cedarsoft.i18n.Locale.US).format(0.0)).isEqualTo("0.00e0")
    assertThat(ExponentialFormat.createExponentialFormat(2, 2, 1, com.cedarsoft.i18n.Locale.US).format(0.000345)).isEqualTo("3.45e-4")
    assertThat(ExponentialFormat.createExponentialFormat(1, 1, 1, com.cedarsoft.i18n.Locale.US).format(0.000348)).isEqualTo("3.5e-4")
    assertThat(ExponentialFormat.createExponentialFormat(3, 3, 2, com.cedarsoft.i18n.Locale.US).format(0.000348)).isEqualTo("34.800e-5")
  }
