...
class DefaultLocaleProviderKtTest {
  ...
  internal fun testOnlyLanguage() {
    assertThat(com.cedarsoft.i18n.Locale("en").convert().language).isEqualTo("en")
    assertThat(com.cedarsoft.i18n.Locale("en").convert().country).isEqualTo("")
  }
  ...
  @Test
  fun testConvertBack() {
    assertThat(com.cedarsoft.i18n.Locale("de-DE").convert()).isEqualTo(Locale.GERMANY)
    assertThat(com.cedarsoft.i18n.Locale("en-US").convert()).isEqualTo(Locale.US)
  }
