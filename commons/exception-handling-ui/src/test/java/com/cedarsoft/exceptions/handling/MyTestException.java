...
public class MyTestException extends ApplicationException {
  public MyTestException(@Nonnull TestExceptionDetails exceptionDetails) {
    this(exceptionDetails, null);
  }

  public MyTestException(@Nonnull TestExceptionDetails exceptionDetails, @Nullable Map<String, ? extends Object> parameters) {
  ...
  public enum TestExceptionDetails implements Details {
    ...
    @NotNull
    @Override
    public String getLocalizedMessage(@NotNull I18nConfiguration i18nConfiguration, @Nullable Map<String, ?> parameters) {
      return "A very long localized messages with a new line:\nThis is the next line!\nAnd another\n\nTwo new lines before";
    }

    @NotNull
    @Override
    public String getTitle(@NotNull I18nConfiguration i18nConfiguration, @Nullable Map<String, ?> parameters) {
      return "da title";
    }
  }
}
