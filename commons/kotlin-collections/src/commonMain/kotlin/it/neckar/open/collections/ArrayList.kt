...
class IntArrayList(capacity: Int = 7) {
  ...
  operator fun iterator(): Iterator<Int> = listIterator(0)
 ...
 */
@Suppress("UNCHECKED_CAST")
class DoubleArrayList(capacity: Int = 7) {
  companion object
  ...
  operator fun iterator(): Iterator<Double> = listIterator(0)
  ...
  fun toDoubleArray(): DoubleArray = this.data.copyOf(length)
 ...
 */
@Suppress("UNCHECKED_CAST")
class FloatArrayList(capacity: Int = 7) {
  companion object
  ...
  operator fun iterator(): Iterator<Float> = listIterator(0)
