...
import it.neckar.open.javafx.combo.ItemThatMayBeDisabled
import it.neckar.open.javafx.combo.ListViewListCellCallbackForItemThatMayBeDisabled
...
object Components {
  ...
  fun <T> comboBoxWithOptionalItems(property: Property<T>, options: ObservableList<ItemThatMayBeDisabled<T>>, converter: (T) -> String): ComboBox<ItemThatMayBeDisabled<T>> {
    ...
    it.neckar.open.javafx.BidirectionalBinding.bindBidirectional(
