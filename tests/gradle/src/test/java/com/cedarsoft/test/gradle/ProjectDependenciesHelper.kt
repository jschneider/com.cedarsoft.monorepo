...
object ProjectDependenciesHelper {
  ...
  fun createGradleDep(dependency: Dependency): String {
    ...
    if (groupId.startsWith("com.cedarsoft.autoresultat.ng")) {
      return "project(\":closed:autoresultat:ng:${artifactId.replace(".", ":")}\")"
    }
    ...
    val matchingProject =
      when (groupAndArtifact) {
        ...
        "com.cedarsoft.commons.time"                                -> ":open:commons:time"
        ...
        "com.cedarsoft.ktor-http-client"                            -> ":closed:ktor-http-client"
        ...
        "com.cedarsoft.serialization.commons-serializers.jackson"   -> ":open:serialization:serializers:commons:jackson-common-serializers"
        "com.cedarsoft.serialization.commons-serializers.stax-mate" -> ":open:serialization:serializers:commons:stax-mate-common-serializers"
