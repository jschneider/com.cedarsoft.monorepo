 ...
 */
public class StaxMateSerializerGeneratorTest extends MultiFileTestCase {
  @Override
  ...
  public void testSimple() throws Throwable {
    doTest( new PerformAction() {
      ...
      public void performAction( VirtualFile rootDir, VirtualFile rootAfter ) throws Exception {
        ...
        StaxMateSerializerGenerator generator = new StaxMateSerializerGenerator( getProject() );
