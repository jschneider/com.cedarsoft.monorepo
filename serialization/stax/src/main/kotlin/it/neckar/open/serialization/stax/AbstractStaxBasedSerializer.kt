 ...
 * This is especially true for it.neckar.open.serialization.PluggableSerializers.
 * @param <T> the type
...
protected constructor(
  ...
  /**
   * Callback interface used when visiting the children (it.neckar.open.serialization.stax.AbstractStaxBasedSerializer#visitChildren(XMLStreamReader, it.neckar.open.serialization.stax.AbstractStaxBasedSerializer.CB))
   */
  @FunctionalInterface
  interface CB {
    /**
