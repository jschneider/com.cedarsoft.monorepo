...
public class ByteSerializer extends AbstractJacksonSerializer<Byte> {
  ...
  @Override
  public void serialize(@Nonnull JsonGenerator serializeTo, @Nonnull Byte objectToSerialize, @Nonnull Version formatVersion) throws Exception, JsonProcessingException {
    serializeTo.writeNumber(objectToSerialize);
  }

  @Nonnull
  @Override
  public Byte deserialize(@Nonnull JsonParser deserializeFrom, @Nonnull Version formatVersion) throws Exception, JsonProcessingException {
