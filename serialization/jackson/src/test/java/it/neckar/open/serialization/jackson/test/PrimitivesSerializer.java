...
public class PrimitivesSerializer extends it.neckar.open.serialization.jackson.AbstractJacksonSerializer<Primitives> {
  ...
  public PrimitivesSerializer(@Nonnull it.neckar.open.serialization.jackson.IntegerSerializer integerSerializer, @Nonnull it.neckar.open.serialization.jackson.ShortSerializer shortSerializer,
                              @Nonnull it.neckar.open.serialization.jackson.ByteSerializer byteSerializer, @Nonnull it.neckar.open.serialization.jackson.LongSerializer longSerializer,
                              @Nonnull it.neckar.open.serialization.jackson.DoubleSerializer doubleSerializer, @Nonnull FloatSerializer floatSerializer,
    ...
    super("primitives_serializer", it.neckar.open.version.VersionRange.from(1, 0, 0).to());
  ...
  @Override
  public void serialize(@Nonnull com.fasterxml.jackson.core.JsonGenerator serializeTo, @Nonnull Primitives objectToSerialize, @Nonnull it.neckar.open.version.Version formatVersion) throws IOException, it.neckar.open.version.VersionException {
  ...
  public
  @Nonnull
  Primitives deserialize(@Nonnull com.fasterxml.jackson.core.JsonParser deserializeFrom, @Nonnull it.neckar.open.version.Version formatVersion) throws IOException, it.neckar.open.version.VersionException {
    verifyVersionWritable(formatVersion);
