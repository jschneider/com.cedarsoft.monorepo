...
public class PrimitivesSerializerVersionTest extends it.neckar.open.serialization.test.utils.AbstractJsonVersionTest2<Primitives> {
    @NotNull
    ...
    public static final it.neckar.open.serialization.test.utils.VersionEntry ENTRY1 = it.neckar.open.serialization.test.utils.AbstractJsonVersionTest2.create(
            it.neckar.open.version.Version.valueOf(1, 0, 0), PrimitivesSerializerVersionTest.class.getResource("Primitives_1.0.0_1.json"));
