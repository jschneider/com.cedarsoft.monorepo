...
public class PrimitivesSerializerVersionTest extends it.neckar.open.serialization.test.utils.AbstractXmlVersionTest2<Primitives> {
    @NotNull
    @org.junit.experimental.theories.DataPoint
    public static final it.neckar.open.serialization.test.utils.VersionEntry ENTRY1 = it.neckar.open.serialization.test.utils.AbstractXmlVersionTest2.create(it.neckar.open.version.Version.valueOf(1, 0, 0), PrimitivesSerializerVersionTest.class.getResource("Primitives_1.0.0_1.xml"));

    @NotNull
    @Override
    protected it.neckar.open.serialization.StreamSerializer<Primitives> getSerializer() throws Exception {
        return com.google.inject.Guice.createInjector().getInstance(PrimitivesSerializer.class);
    }

    @Override
    protected void verifyDeserialized(@NotNull Primitives deserialized, @NotNull it.neckar.open.version.Version version) {
