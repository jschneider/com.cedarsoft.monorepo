 ...
 * have any questions.
 */
package it.neckar.open.serialization.generator.intellij;
...
import it.neckar.open.serialization.generator.intellij.model.DelegatingSerializer;
import it.neckar.open.serialization.generator.intellij.model.FieldSetter;
...
public abstract class AbstractSerializerGenerator implements SerializerGenerator {
  ...
  protected PsiElement generateSerializeMethod( @Nonnull SerializerModel serializerModel, @Nonnull PsiClass serializerClass ) {
    ...
    methodBuilder.append( "@Override public void serialize (" )
      ...
      .append( notNull() )
      .append( "it.neckar.open.version.Version formatVersion" )
      .append( ")throws java.io.IOException, it.neckar.open.version.VersionException, " ).append( serializeExceptionType ).append( "{" );
  ...
  protected PsiElement generateDeserializeMethod( @Nonnull SerializerModel serializerModel, @Nonnull PsiClass serializerClass ) {
    ...
    methodBuilder.append( "@Override " ).append( notNull() ).append( "public " ).append( classToSerialize.getQualifiedName() ).append( " deserialize(" )
      ...
      .append( notNull() )
      .append( "it.neckar.open.version.Version formatVersion" ).append( ") throws java.io.IOException, it.neckar.open.version.VersionException, " ).append( serializeExceptionType ).append( " {" );
