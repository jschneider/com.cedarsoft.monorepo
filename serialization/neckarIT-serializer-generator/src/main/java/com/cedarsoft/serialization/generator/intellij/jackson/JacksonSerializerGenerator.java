...
public class JacksonSerializerGenerator extends AbstractSerializerGenerator {
  public JacksonSerializerGenerator( @Nonnull Project project ) {
    super( project, "it.neckar.open.serialization.jackson.AbstractJacksonSerializer", "com.fasterxml.jackson.core.JsonGenerator", "com.fasterxml.jackson.core.JsonParser", "com.fasterxml.jackson.core.JsonProcessingException" );
  }
  ...
  protected void callSuperConstructor( @Nonnull SerializerModel serializerModel, @Nonnull StringBuilder constructorBuilder ) {
    constructorBuilder.append( "){" )
      .append( "super(\"" ).append( createType( serializerModel.getClassToSerializeQualifiedName() ) ).append( "\", it.neckar.open.version.VersionRange.from(1,0,0).to());" );
  }
  ...
  protected void appendDeserializeFieldStatements( @Nonnull SerializerModel serializerModel, @Nonnull StringBuilder methodBody ) {
    ...
    {
      //While for fields
      methodBody.append( "it.neckar.open.serialization.jackson.JacksonParserWrapper parser = new it.neckar.open.serialization.jackson.JacksonParserWrapper( deserializeFrom );" +
