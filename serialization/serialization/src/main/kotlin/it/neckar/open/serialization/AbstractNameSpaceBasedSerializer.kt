...
abstract class AbstractNameSpaceBasedSerializer<T : Any, S : Any, D : Any> protected constructor(
   ...
   * throws it.neckar.open.version.VersionException          the if the version does not fit the expected range
  ...
  companion object {
     ...
     * throws it.neckar.open.version.VersionException if the namespace uri does not contain any version information   *
