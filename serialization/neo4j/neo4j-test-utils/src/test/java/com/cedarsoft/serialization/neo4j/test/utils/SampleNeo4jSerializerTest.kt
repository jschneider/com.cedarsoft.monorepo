...
class SampleNeo4jSerializerTest : AbstractNeo4JTest() {
  ...
  fun testWrongLabel() {
    ...
    try {
      ...
      Assertions.assertThat(e.message).contains("[INVALID_TYPE] Invalid type. Expected <com.cedarsoft.test.person> but was <").contains("lab1").contains("lab2").contains("lab3")
    }
  }
