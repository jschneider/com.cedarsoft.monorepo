...
public class BooleanSerializer extends AbstractStaxMateSerializer<Boolean> {
  ...
  @Nonnull
  @Override
  public Boolean deserialize( @Nonnull XMLStreamReader deserializeFrom, @Nonnull Version formatVersion ) throws IOException, VersionException, XMLStreamException {
    return Boolean.parseBoolean( getText( deserializeFrom ) );
  }
}
