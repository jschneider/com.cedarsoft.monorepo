...
public class ShortSerializer extends AbstractStaxMateSerializer<Short> {
  ...
  @Override
  public void serialize(@Nonnull SMOutputElement serializeTo, @Nonnull Short objectToSerialize, @Nonnull Version formatVersion ) throws IOException, VersionException, XMLStreamException {
