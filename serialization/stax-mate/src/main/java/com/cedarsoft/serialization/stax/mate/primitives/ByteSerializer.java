...
/**
 */
public class ByteSerializer extends AbstractStaxMateSerializer<Byte> {
  @Inject
  public ByteSerializer() {
    super( "byte", "http://cedarsoft.com/primitives", VersionRange.single( 1, 0, 0 ) );
  }
  ...
  @Nonnull
  @Override
  public Byte deserialize( @Nonnull XMLStreamReader deserializeFrom, @Nonnull Version formatVersion ) throws IOException, VersionException, XMLStreamException {
    return Byte.parseByte( getText( deserializeFrom ) );
  }
}
