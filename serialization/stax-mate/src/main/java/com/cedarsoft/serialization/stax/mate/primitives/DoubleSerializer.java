...
public class DoubleSerializer extends AbstractStaxMateSerializer<Double> {
  ...
  @Override
  public void serialize(@Nonnull SMOutputElement serializeTo, @Nonnull Double objectToSerialize, @Nonnull Version formatVersion ) throws IOException, VersionException, XMLStreamException {
