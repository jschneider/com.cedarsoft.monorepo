...
import static com.cedarsoft.AssertUtils.assertFileByHash;
import static com.cedarsoft.AssertUtils.assertFileByHashes;
...
public class AssertUtilsFileCompareTest {
  ...
  public void testOneOfFail() throws IOException {
    ...
    expectedException.expectMessage(
      "Stored questionable file under test at </tmp/junit-failed-files/com.cedarsoft.AssertUtilsFileCompareTest/testOneOfFail/a>\n" +
  ...
  public void testFail() throws Exception {
    expectedException.expect( AssertionError.class );
    expectedException.expectMessage( "Stored questionable file under test at </tmp/junit-failed-files/com.cedarsoft.AssertUtilsFileCompareTest/testFail/a>\n" +
